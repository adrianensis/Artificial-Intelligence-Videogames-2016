...
public class HeavyUnit extends Unit {
	...
	public HeavyUnit(String key, int team, String textureName, Vector2 pos) {
		super(key, team,textureName, 1f*Scene.SCALE, 40*Scene.SCALE, 5f*Scene.SCALE, 1, pos, 10, 100, 1*Scene.SCALE, 6*Scene.SCALE, 0.5f);
